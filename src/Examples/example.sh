...
declare -r PATH_VENDOR_LINUX_BASH_DISTRIBUTION="$PATH_VENDOR/Linux.Bash.Distribution"

# Create the Vendor directory if it doesn't exist
[[ -d "$PATH_VENDOR_LINUX_BASH_DISTRIBUTION" ]] || mkdir -p "$PATH_VENDOR_LINUX_BASH_DISTRIBUTION"


cd "$PATH_VENDOR_LINUX_BASH_DISTRIBUTION"
...
. "$PATH_VENDOR_LINUX_BASH_DISTRIBUTION/Distribution/Run.sh"
cd "$PATH_ROOT"
